...
<b> 2.1. linux/MaxOS&nbsp;&nbsp;&nbsp;   [Download](https://github.com/BGI-shenzhen/LDBlockShow/archive/v1.34.tar.gz) </b>
...
* Example 4) show Figure (heatmap+Annotation+GWAS similar to locusroom)
```
